...
<head>
  ...
  <title>Sistem Informasi Penggajian Koperasi syari'ah bersinar baithul tanwil muhammadyah(BTM)</title>
...
<body class="hold-transition skin-red sidebar-mini">
  ...
  <strong>PENGGAJIAN</strong>
      ...
      <span class="logo-mini"><b>PENGGAJIAN</b></span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="aset/img/logo.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">    
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?m1=karyawan&m2=datakaryawan"><i class="fa fa-circle-o"></i>Data Karyawan</a></li>   
            <li class="active"><a href="?m1=penggajian&m2=penggajian"><i class="fa fa-circle-o"></i> Kelola Penggajian</a></li>
            <li class="active"><a href="?m1=laporan&m2=laporan"><i class="fa fa-circle-o"></i> Laporan Penggajian</a></li> 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">Yudis</a>.</strong> All rights
    reserved.
  </footer>
